...
export default function DarkModeToggle() {
  ...
  const darkIcon = (
    <div className="bg-[#6B4E92] flex items-center justify-center p-[5.5px] rounded-full shadow-inner md:p-[9px]">
      <FaMoon color="white" className="w-[11px] h-[11px] md:w-[29px] md:h-[29px]" />
    </div>
  )
  const lightIcon = (
    <div className="bg-white flex items-center justify-center p-[5.5px] rounded-full shadow-inner md:p-[9px]">
