...
md:items-start md:px-10 md:pb-4`}
    >
      <h2
        className={`${headerColor} font-extrabold text-[1.5em] mb-8 md:text-[2.25em]`}
      >
        Let&apos;s work together!{" "}
        <span className={headerSpanColor}>Contact Me</span>
      </h2>
      ...
      <ul className="flex flex-col gap-y-6 mb-[64px] text-[0.875em] md:text-[1em]">
        ...
        <li className="flex gap-x-[26px]">
          ...
          <a
            href="https://www.linkedin.com/in/tife-olatunji-b12729296"
            target="_blank"
            className={contactColor}
          >
            Tife Olatunji
      ...
      <div className="pt-4 px-[9.5px] border-t border-[#D3D3D3] flex flex-col items-center justify-center md:w-full">
        <p className={`${contactSpanColor} text-[0.875em] md:text-[1em]`}>
          <span>&copy;</span> 2025 Tife Olatunji. All rights reserved
        </p>
        <p
          className={`${isDarkMode ? "text-white" : "text-[#D3D3D3]"} text-[0.625em] md:text-[0.75em]`}
        >
          Designed by{" "}
          <a
            href="https://www.linkedin.com/in/marienoelemechebe/"
            target="_blank"
          >
            {" "}
            Marienoel Emechebe
